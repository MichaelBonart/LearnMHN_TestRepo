...
def main():
    ...
    data_properties = o_opt.get_data_properties()
    ...
    print("Plot oMHN")
    o_opt.result.plot(logarithmic=False)
    plt.savefig("oMHN_plot.png")

    plt.cla()

    print("Plot oMHN logarithmic")
    o_opt.result.plot(logarithmic=True)
    plt.savefig("oMHN_plot_log.png")
